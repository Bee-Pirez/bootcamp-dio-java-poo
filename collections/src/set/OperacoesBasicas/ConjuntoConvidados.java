...
public class ConjuntoConvidados {
    ...
    public static void main(String[] args) {
        ...
        conjuntoConvidados.adicionarConvidado("Beatriz", 1234);
        conjuntoConvidados.adicionarConvidado("Gustavo", 1235);
        conjuntoConvidados.adicionarConvidado("Leonardo", 1235);
